...
float getposition(){
  ...
  float sum1;
  float area;
  sensorNormalizado[0]=100*(digitalRead(4)-sensoresMin[0])/(sensoresMax[0]-sensoresMin[0]); //MAPEO DE SENSORES
  sensorNormalizado[1]=100*(analogRead(A7)-sensoresMin[1])/(sensoresMax[1]-sensoresMin[1]);
  sensorNormalizado[2]=100*(analogRead(A6)-sensoresMin[2])/(sensoresMax[2]-sensoresMin[2]);
  sensorNormalizado[3]=100*(analogRead(A0)-sensoresMin[3])/(sensoresMax[3]-sensoresMin[3]);
  sensorNormalizado[4]=100*(analogRead(A3)-sensoresMin[4])/(sensoresMax[4]-sensoresMin[4]);
  sensorNormalizado[5]=100*(digitalRead(26)-sensoresMin[5])/(sensoresMax[5]-sensoresMin[5]);
