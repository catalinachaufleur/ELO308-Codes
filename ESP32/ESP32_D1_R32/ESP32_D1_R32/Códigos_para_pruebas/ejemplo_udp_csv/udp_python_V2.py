...
import socket
#Ajustables
file_name = "C:\\Users\\sapet\\Dropbox\\git\\dash_tren2_step\\prueba_4.csv"  # archivo csv

UDP_IP = "192.168.1.12" # ip del computador que recibe datos (mismo que el que corre este script)
UDP_PORT = 5555
#UDP
