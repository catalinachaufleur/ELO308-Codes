...
# Funciones ------------------------------------------
    ...
    def start_monitoring_theta(self):
        self.animate(6)
    ...
    def open_monitor_window(self):
        ...
        start_monitor_button.grid(row=len(self.ip_entry_widgets) + 9, column=2, padx=10, pady=10)

        start_monitor_button = tk.Button(self, text="Monitorear Distancia", command=self.start_monitoring_theta)
        start_monitor_button.grid(row=len(self.ip_entry_widgets) + 10, column=2, padx=10, pady=10)
