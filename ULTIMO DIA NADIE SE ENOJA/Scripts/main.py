...
positions = [[0, 0], [0, 1080], [1920, 0], [1920, 1080]]		# for perspective transform -> corresponde a la forma del video que se quiere tener, para no modificar usar la resolución base
countClicks = 0

fileName = 'Track.mov'
trackName = 'trackPoints.csv'
...
writer.writerow(['time(s)', 'distance12(cm)', 'distance23(cm)'])
...
#########		distance34Arr = np.append(distance34Arr, distance34_cm)
		...
		# write CSV file
		writer.writerow([seconds, distance12_cm, distance23_cm])
