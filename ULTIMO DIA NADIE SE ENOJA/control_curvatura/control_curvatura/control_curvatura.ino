...
#define IP_monitoreo "192.168.1.100"     //ip del dispositivo que va a supervisar los datos (ip desktop Carlos)
...
////////
#define EtiquetaRobot "L"   // "L": Robot0 (lider)   "R": robot1    "S": robot2    "T": Robot3    "O": Robot4 
#define led 2
